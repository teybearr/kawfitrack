      ...
      {(() => {
        ...
        return (
          <div className="relative z-10 text-center">
            <div className="inline-flex flex-col items-center bg-dusk border border-blush/20 rounded-2xl px-10 py-5">
              <p className="font-caveat text-blush text-sm mb-1 tracking-wide">it's been</p>
              <p className="font-playfair text-6xl text-cream leading-none">{days}</p>
              <p className="font-caveat text-muted text-sm mt-1">days & counting 🎀</p>
            </div>
          </div>
        );
      })()}
